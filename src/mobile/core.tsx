...
import { switch_to_pc } from './device';
import {
...
class MobileUI {
    ...
    constructor() {
        this.current_theme = 'b';
    }

    init(c?: typeof config) {
        this.set_file();
    ...
    changeGlobalTheme(theme: string) {
    ...
    print_query_content(content: string) {
        document.getElementById('query_content')!.innerHTML = content;
    }
    switch_theme(theme: string) {
        this.changeGlobalTheme(theme);
        this.current_theme = theme;
    }
     ...
     */
    get_reader_when_checked_file_API(): Maybe<FileReader> {
    ...
    set_file() {
        (document.getElementById('base_file') as any).onchange = function(this: HTMLInputElement) {
            ...
            reader.onload = function(this) {
                ...
                // By lines
                let lines = (this.result as string).split('\n');
